...
model = torch.load('/mnt/c/Users/ska06/PycharmProjects/pythonProject1/mysite/totaldata_model.pt',
                   map_location=device)  # 전체 모델을 통째로 불러옴, 클래스 선언 필수
# model = BERTClassifier('C:/Users/mjy30/Django_Prac/totaldata_model.pt').to(device)
model.load_state_dict(torch.load('/mnt/c/Users/ska06/PycharmProjects/pythonProject1/mysite/model_state_dict2.pt',
