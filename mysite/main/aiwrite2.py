...
model.load_state_dict(torch.load('/mnt/e/CMNAI2/new/final/rnn/rnn_model_hs64_layers8.pth', map_location=device))  # 경로 설정 필요
...
# 1단계 : 완전 로컬
# origin_folder_name = "/mnt/c/Users/ska06/PycharmProjects/pythonProject1/mysite/static/diary_data/"
# result_folder_name = "/mnt/c/Users/ska06/PycharmProjects/pythonProject1/mysite/static/last_data/"
# text_folder_name = "/mnt/c/Users/ska06/PycharmProjects/pythonProject1/mysite/static/text_data/"
# user_folder_name = "/mnt/c/Users/ska06/PycharmProjects/pythonProject1/mysite/static/user_data/"

# 2단계 : media/images/
origin_folder_name = "/mnt/c/Users/ska06/PycharmProjects/pythonProject1/mysite/media/images/"
result_folder_name = "/mnt/c/Users/ska06/PycharmProjects/pythonProject1/mysite/media/images/result_folder/"
user_folder_name = "/mnt/c/Users/ska06/PycharmProjects/pythonProject1/mysite/media/images/user_folder/"
# 경로 설정 여기만 하면 됩니다!!!!
...
class last2():
    ...
    def data_storage(current_user):
        ...
        os.makedirs(f"{user_folder_name}{str(current_user)}/word_save", exist_ok=True)

        test_img_path_list = []
        # 2단계 : /media/images/
        img_name = "image_login_top_and_chosung_quiz.jpg"
        ...
        #     img_name = "0.png"
        img_path = os.path.join(f"{origin_folder_name}", img_name)
        move_path = f"{user_folder_name}{str(current_user)}/word_save" + "/"

        user_img_name_index = len(os.listdir(f"{move_path}"))
        user_image_name = f"/단어쓰기 ({user_img_name_index}).png"
        img_url = str(move_path + img_name)
        img_url_list = img_url.replace('/', '*/').split('*')
        url_html = "".join(img_url_list[img_url_list.index('/media'):-1]) + user_image_name       # /static ~~~
        print("####################### " + url_html)
