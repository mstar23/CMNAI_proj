...
# C:/CMNAI2/new/final/rnn/rnn_model_hs64_layers8.pth
# new/final/rnn/rnn_model_hs64_layers8.pth
...
class last():
    ...
    def data_storage(current_user):
        ...
        url_html = "/main"+"".join(img_url_list[img_url_list.index('/media'):-1]) + "/" + user_image_name  # /static ~~
        # url_html = "/mnt/c/Users/ska06/PycharmProjects/pythonProject1/mysite/media/images/image_bottom.jpg"
        time.sleep(1)
    ...
    def data_ready():
        ...
        for i in range(len(result_img_path_list)):
            ...
            result_img_np = np.array(img)  # 이미지 ㅁ-> 넘파이
