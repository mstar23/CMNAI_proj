...
ctx.rect(10,10,240,240);
//ctx.fillRect(10,10,110,110)
ctx.rect(260,10,240,240);
ctx.rect(510,10,240,240);
ctx.rect(760,10,240,240);
...
ctx_top.rect(10,10,240,240);
//ctx.fillRect(10,10,110,110)
ctx_top.rect(260,10,240,240);
ctx_top.rect(510,10,240,240);
ctx_top.rect(760,10,240,240);
...
function handleCanvasClick(event){
        ...
        const y = event.offsetY;
        if (filling){
        if (x < 255 && y < 255){ctx.fillRect(10,10,240,240); ctx_top.fillRect(10,10,240,240);}
        else if (x < 505 && y < 505){ctx.fillRect(260,10,240,240); ctx_top.fillRect(260,10,240,240);}
        else if (x < 755 && y < 755){ctx.fillRect(510,10,240,240); ctx_top.fillRect(510,10,240,240);}
        else if (x < 1010 && y < 1010){ctx.fillRect(760,10,240,240); ctx_top.fillRect(760,10,240,240);}
        }
}
